...
<p align="center">
  <img src="{{ '/assets/img/avatar.jpg?v=3' | relative_url }}" alt="Ashish Verma" width="140" height="140" style="border-radius:50%; border:3px solid #b91c1c; object-fit:cover;" />
</p>
...
### [CortexOps](https://www.getcortexops.com) — AI agent reliability  
[GitHub](https://github.com/ashishodu2023/cortexops) · [PyPI](https://pypi.org/project/cortexops/)

CI layer for agents: golden datasets, tool-call gates, and regression diffs that block bad deploys (LangGraph, CrewAI, AutoGen, …).

### [TideVec](https://github.com/ashishodu2023/TideVec) — Temporal vector database  
[GitHub](https://github.com/ashishodu2023/TideVec) · [PyPI](https://pypi.org/project/tidevec/)
...
| [EAPO](https://github.com/ashishodu2023/eapo) | Energy-aware prompt optimization (Bayesian search) |
| [ClaimLensAI](https://github.com/ashishodu2023/ClaimLensAI) | Multimodal damage-claim intelligence |
| [VAE-BiLSTM pipeline](https://github.com/ashishodu2023/vae_bilstm_tfx_pipeline) | End-to-end anomaly detection with TFX |

More: [github.com/ashishodu2023](https://github.com/ashishodu2023)

---

## Papers

1. **[A Unified Metrics Framework for Evaluating Coordination Dynamics in LLM-Based Multi-Agent Systems](https://doi.org/10.5281/zenodo.19756290)** — Zenodo · NeurIPS 2026 (under review)

2. **[Energy-Aware Prompt Optimization for Large Language Models](https://doi.org/10.36227/techrxiv.175615629.90190202/v1)** — TechRxiv · [code](https://github.com/ashishodu2023/eapo)

3. **[VAE-BiLSTM Anomaly Detection for Beam Stability in Spallation Neutron Sources](https://doi.org/10.36227/techrxiv.175615627.78320502/v1)** — TechRxiv · Jefferson Lab · [code](https://github.com/ashishodu2023/vae_bilstm_tfx_pipeline)

4. **TideVec: Production Vector DB with Temporal Decay & Causal Graph** — SSRN preprint · [code](https://github.com/ashishodu2023/TideVec)
